(function () {
    ...
    textBar.onkeyup = async function () {
        ...
        let response = await fetch(`https://superheroapi.com/api/1830664100607249/search/${name}`).catch(e => {
            console.log("error");
        });
    ...
    //     let response = await fetch(`https://www.superheroapi.com/api.php/1830664100607249/${id}`, { signal }).catch(e => {
    //         console.log("error");
    //     });
    //     let data = await response.json();
    //     renderOnLoad(data);
